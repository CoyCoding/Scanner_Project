...
public class DockDoor {
	//
    //Dock Door Class will implement location when optimized 
	//This is because Dock Doors can be loaded() unloaded() but locked out from move(); 
	//The var closed will only be used when the door location is closed.
	//All lpns will be purged and put in-transit as location var in location will then only be managed by
	//a different function once again for safety reasons.
	//
	private int date1;
	private int date2;
	...
	public DockDoor(String department, String date1, String date2) {
		//This constructor be an int but then I would have other method code !! optimize later!!
		//
		
		this.department = department;
		//Sets door department ex. WRD, ERD
